...
Serve.Run(
    RunOptions.Default //创建一个 WebApplication 主机的配置对象
    .ConfigureBuilder(builder => builder.Host.UseWindowsService())
    .AddWebComponent<WebComponent>());//注册 Furion 组件，相当于原来的 AddWebComponent<WebComponent>()
